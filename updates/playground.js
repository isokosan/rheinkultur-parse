require('./run')(async () => {
  ...
  for (const quarter of ['Q2', 'Q3', 'Q4']) {
    ...
    const criteria = ['Company:FNFCxMgEEr:include']
    console.log({ name, criteria, orderType, date, dueDate, startedBefore, lastControlBefore, lastControlAt, untilDate })
