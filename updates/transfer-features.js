...
// async function cubeDataToFeatuers () {
//   const query = $query('Cube')
//     .equalTo('features', null)
//     .notEqualTo('scoutData', null)
//   let i = 0
//   const total = await query.count({ useMasterKey: true })
//   return query.eachBatch(async (batch) => {
//     for (const cube of batch) {
//       const features = cube.set('features', cube.get('scoutData'))
//       await $saveWithEncode(cube, null, { useMasterKey: true, context: { updating: true } })
//       i++
//     }
//     // progress
//     console.log(`${i}/${total} done, ${parseInt(i / total * 100)}%`)
//   }, { useMasterKey: true })
// }

// require('./run')(() => cubeDataToFeatuers())
